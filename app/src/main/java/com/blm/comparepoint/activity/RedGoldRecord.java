...
import com.blm.comparepoint.adapter.RedGoldRecordAdapter;
...
public class RedGoldRecord extends BaseActivity implements XRecyclerView.LoadingListener {
    ...
    private RedGoldRecordAdapter myOrderAdapter;
    ...
    private void initView() {
        txtTitle.setText("红包统计记录");
        orderList = new ArrayList();
        myOrderAdapter = new RedGoldRecordAdapter(orderList);
            ...
            public void onResponse(String response) {
                ...
                if (!TextUtils.isEmpty(response)) {
                    ...
                    if (baseBean.Success) {
                        ...
                        SPUtils.put(context, Constants.USERAMOUNT,  ((long) SPUtils.get(context, Constants.USERAMOUNT, 0l) +
